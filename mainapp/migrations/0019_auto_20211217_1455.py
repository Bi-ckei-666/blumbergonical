# Generated by Django 3.2.7 on 2021-12-17 11:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0018_auto_20211215_1611'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='mainapp.Order', verbose_name='Заказы полкупателя'),
        ),
    ]
